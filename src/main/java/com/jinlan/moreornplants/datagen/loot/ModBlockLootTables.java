...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
                ...
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        ...
                        .when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block)
                                .setProperties(StatePropertiesPredicate.Builder.properties()
                                        ...
                                        .hasProperty(WaterLotusBlock.ON_FARMLAND, false))))
                .withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
                        .add(LootItem.lootTableItem(ModItems.LOTUS_ROOT.get())
                                .apply(SetItemCountFunction.setCount(UniformGenerator.between(3, 4))))
                        .when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block)
        ...
        this.dropOther(ModBlocks.BLUE_CHINESE_WISTERIA_PLANT.get(), ModBlocks.BLUE_CHINESE_WISTERIA.get().asItem());
        this.dropSelf(ModBlocks.RED_CHINESE_WISTERIA.get());
        this.dropOther(ModBlocks.RED_CHINESE_WISTERIA_PLANT.get(), ModBlocks.RED_CHINESE_WISTERIA.get().asItem());
        this.dropSelf(ModBlocks.NANJING_WISTERIA.get());
        this.dropOther(ModBlocks.NANJING_WISTERIA_PLANT.get(), ModBlocks.NANJING_WISTERIA.get().asItem());
