...
public class ModBlockTagGenerator extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider pProvider) {
        ...
        this.tag(BlockTags.FLOWER_POTS)
                ...
                .add(ModBlocks.POTTED_TAIWAN_CHERRY_SAPLING.get())
                ...
                .add(ModBlocks.POTTED_WHITE_CHRYSANTHEMUM.get(), ModBlocks.POTTED_BLACK_CHRYSANTHEMUM.get(), ModBlocks.POTTED_GREEN_CHRYSANTHEMUM.get())
                ...
                .add(ModBlocks.POTTED_SPRING_CYMBIDIUM.get(), ModBlocks.POTTED_SUMMER_CYMBIDIUM.get())
                .add(ModBlocks.POTTED_AUTUMN_CYMBIDIUM.get(), ModBlocks.POTTED_WINTER_CYMBIDIUM.get())
                .add(ModBlocks.POTTED_PEONY.get(), ModBlocks.POTTED_LIGHT_PINK_PEONY.get())
                .add(ModBlocks.POTTED_VIOLET_PINK_PEONY.get(), ModBlocks.POTTED_PINK_PEONY.get())
                .add(ModBlocks.POTTED_RED_PEONY.get(), ModBlocks.POTTED_LIGHT_RED_PEONY.get())
                .add(ModBlocks.POTTED_INK_RED_PEONY.get(), ModBlocks.POTTED_VERMILION_PEONY.get())
                .add(ModBlocks.POTTED_PURPLE_PEONY.get(), ModBlocks.POTTED_LIGHT_PURPLE_PEONY.get())
                .add(ModBlocks.POTTED_INK_PURPLE_PEONY.get(), ModBlocks.POTTED_VIOLET_PEONY.get())
                .add(ModBlocks.POTTED_YELLOW_PEONY.get(), ModBlocks.POTTED_LIGHT_YELLOW_PEONY.get())
                .add(ModBlocks.POTTED_OCHRE_YELLOW_PEONY.get(), ModBlocks.POTTED_GOLDEN_PEONY.get())
                .add(ModBlocks.POTTED_WHITE_PEONY.get(), ModBlocks.POTTED_INK_PEONY.get())
                .add(ModBlocks.POTTED_BLUE_PEONY.get(), ModBlocks.POTTED_GREEN_PEONY.get())
                .add(ModBlocks.POTTED_COLORFUL_PEONY.get())
                .add(ModBlocks.POTTED_LIGHT_COLORFUL_PEONY.get(), ModBlocks.POTTED_INK_COLORFUL_PEONY.get())
                ...
                .add(ModBlocks.POTTED_RED_PINK_CHINESE_ROSE.get())
                .add(ModBlocks.POTTED_RED_YELLOW_CHINESE_ROSE.get())
                .add(ModBlocks.POTTED_RED_WHITE_CHINESE_ROSE.get())
                ...
                .add(ModBlocks.POTTED_BRANCHY_TAMARISK.get(), ModBlocks.POTTED_GOLDEN_BRANCHY_TAMARISK.get())
        ...
        this.tag(BlockTags.FLOWERS)
                ...
                .add(ModBlocks.TAIWAN_CHERRY_SAPLING.get())
                ...
                .add(ModBlocks.TAIWAN_CHERRY_LEAVES.get())
        ...
        this.tag(ModTags.Blocks.DOVE_TREE_LOGS)
                .add(ModBlocks.DOVE_TREE_LOG.get(),
                        ModBlocks.DOVE_TREE_WOOD.get(),
                        ModBlocks.STRIPPED_DOVE_TREE_LOG.get(),
                        ModBlocks.STRIPPED_DOVE_TREE_WOOD.get());
        this.tag(ModTags.Blocks.CHINABERRY_LOGS)
                .add(ModBlocks.CHINABERRY_LOG.get(),
                        ModBlocks.CHINABERRY_WOOD.get(),
                        ModBlocks.STRIPPED_CHINABERRY_LOG.get(),
                        ModBlocks.STRIPPED_CHINABERRY_WOOD.get());
        this.tag(ModTags.Blocks.DESERT_POPLAR_LOGS)
                .add(ModBlocks.DESERT_POPLAR_LOG.get(),
                        ModBlocks.DESERT_POPLAR_WOOD.get(),
                        ModBlocks.STRIPPED_DESERT_POPLAR_LOG.get(),
                        ModBlocks.STRIPPED_DESERT_POPLAR_WOOD.get());

        this.tag(BlockTags.SAPLINGS)
                .add(ModBlocks.RED_MEI_SAPLING.get(), ModBlocks.WHITE_MEI_SAPLING.get(), ModBlocks.GOLDEN_MEI_SAPLING.get())
                .add(ModBlocks.GREEN_CALYX_MEI_SAPLING.get(), ModBlocks.DOUBLE_PINK_MEI_SAPLING.get())
                .add(ModBlocks.VERSICOLOR_MEI_SAPLING.get(), ModBlocks.RED_WEEPING_MEI_SAPLING.get())
        ...
        this.tag(BlockTags.REPLACEABLE_BY_TREES)
                ...
                .add(ModBlocks.LUOYANG_RED_PEONY.get(), ModBlocks.TWO_QIAO_PEONY.get(), ModBlocks.VERSICOLOR_PEONY.get())
        ...
        this.tag(BlockTags.SMALL_FLOWERS)
                ...
                .add(ModBlocks.CAMELLIA.get(), ModBlocks.PINK_CAMELLIA.get())
                .add(ModBlocks.WHITE_CAMELLIA.get(), ModBlocks.VERSICOLOR_CAMELLIA.get())
                .add(ModBlocks.RED_AZALEA.get(), ModBlocks.MAYING_RHODODENDRON.get())
                .add(ModBlocks.DEWDROP_RHODODENDRON.get(), ModBlocks.CHARMING_RHODODENDRON.get())
                .add(ModBlocks.GREAT_WHITE_RHODODENDRON.get(), ModBlocks.PURPLE_RHODODENDRON.get())
                .add(ModBlocks.PINK_RHODODENDRON.get(), ModBlocks.CHINESE_AZALEA.get())
                ...
                .add(ModBlocks.BRANCHY_TAMARISK.get())
        ...
        this.tag(ForgeTags.Blocks.STRIPPED_LOGS)
        ...
        this.tag(ForgeTags.Blocks.STRIPPED_WOODS)
