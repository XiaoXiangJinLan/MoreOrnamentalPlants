...
public class ModBlockTagGenerator extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider pProvider) {
        ...
        this.tag(BlockTags.FLOWER_POTS)
                ...
                .add(ModBlocks.POTTED_PURPLE_WHITE_CHINESE_ROSE.get(), ModBlocks.POTTED_PURPLE_CHINESE_ROSE.get())
        ...
        this.tag(BlockTags.SMALL_FLOWERS)
                ...
                .add(ModBlocks.CUT_WHITE_ROSE.get(), ModBlocks.CUT_BAOHUA_CHINESE_ROSE.get(), ModBlocks.CUT_PURPLE_ROSE.get())
                .add(ModBlocks.CUT_WINTERSWEET.get(), ModBlocks.CUT_COTTON_ROSE.get());
        ...
        this.tag(CommonTags.Blocks.PEACH_SAPLING)
                .add(ModBlocks.ORNAMENTAL_PEACH_SAPLING.get(), ModBlocks.WILD_PEACH_SAPLING.get(),
                        ModBlocks.WHITE_PEACH_SAPLING.get(), ModBlocks.IMMORTAL_PEACH_SAPLING.get());
        this.tag(CommonTags.Blocks.PEACH_LEAVES)
                .add(ModBlocks.ORNAMENTAL_PEACH_LEAVES.get(), ModBlocks.WILD_PEACH_LEAVES.get(),
                        ModBlocks.WHITE_PEACH_LEAVES.get(), ModBlocks.IMMORTAL_PEACH_LEAVES.get());
        ...
        this.tag(CommonTags.Blocks.CHINESE_ROSE)
                ...
                .add(ModBlocks.PURPLE_WHITE_CHINESE_ROSE.get(), ModBlocks.PURPLE_CHINESE_ROSE.get());
