...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        simpleBlock(ModBlocks.POTTED_CHINESE_TAMARISK.get(), models().singleTexture("potted_chinese_tamarisk", ResourceLocation.parse("flower_pot_cross"), "plant",
                ResourceLocation.parse(MoreOrnPlants.MODID + ":" + "block/potted_chinese_tamarisk")).renderType("cutout"));
        flowerBlock(ModBlocks.GOLDEN_CHINESE_TAMARISK);
        simpleBlock(ModBlocks.POTTED_GOLDEN_CHINESE_TAMARISK.get(), models().singleTexture("potted_golden_chinese_tamarisk", ResourceLocation.parse("flower_pot_cross"), "plant",
                ResourceLocation.parse(MoreOrnPlants.MODID + ":" + "block/potted_golden_chinese_tamarisk")).renderType("cutout"));
