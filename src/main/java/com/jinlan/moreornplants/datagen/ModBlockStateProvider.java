...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        simpleBlock(ModBlocks.POTTED_GOLDEN_MEI_SAPLING.get(), models().singleTexture("potted_golden_mei_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_RED_WEEPING_MEI_SAPLING.get(), models().singleTexture("potted_red_weeping_mei_sapling", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.RED_WEEPING_MEI_SAPLING.get())).renderType("cutout"));
        saplingBlock(ModBlocks.WHITE_WEEPING_MEI_SAPLING);
        simpleBlock(ModBlocks.POTTED_WHITE_WEEPING_MEI_SAPLING.get(), models().singleTexture("potted_white_weeping_mei_sapling", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.WHITE_WEEPING_MEI_SAPLING.get())).renderType("cutout"));
        saplingBlock(ModBlocks.GREEN_WEEPING_MEI_SAPLING);
        simpleBlock(ModBlocks.POTTED_GREEN_WEEPING_MEI_SAPLING.get(), models().singleTexture("potted_green_weeping_mei_sapling", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.GREEN_WEEPING_MEI_SAPLING.get())).renderType("cutout"));
        saplingBlock(ModBlocks.PINK_WEEPING_MEI_SAPLING);
        simpleBlock(ModBlocks.POTTED_PINK_WEEPING_MEI_SAPLING.get(), models().singleTexture("potted_pink_weeping_mei_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_VERSICOLOR_WEEPING_MEI_SAPLING.get(), models().singleTexture("potted_versicolor_weeping_mei_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_UPRIGHT_CRABAPPLE_SAPLING.get(), models().singleTexture("potted_upright_crabapple_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_WHITE_CRABAPPLE_SAPLING.get(), models().singleTexture("potted_white_crabapple_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_GOLDEN_CRABAPPLE_SAPLING.get(), models().singleTexture("potted_golden_crabapple_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_WEEPING_CRABAPPLE_SAPLING.get(), models().singleTexture("potted_weeping_crabapple_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_PINK_APRICOT_SAPLING.get(), models().singleTexture("potted_pink_apricot_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_WHITE_PEACH_SAPLING.get(), models().singleTexture("potted_white_peach_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_TAIWAN_CHERRY_SAPLING.get(), models().singleTexture("potted_taiwan_cherry_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_FLOWERING_PURPLE_LEAF_PLUM_SAPLING.get(), models().singleTexture("potted_flowering_purple_leaf_plum_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_PURPLE_LEAF_PLUM_SAPLING.get(), models().singleTexture("potted_purple_leaf_plum_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_GOLDEN_OSMANTHUS_SAPLING.get(), models().singleTexture("potted_golden_osmanthus_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_ORANGE_OSMANTHUS_SAPLING.get(), models().singleTexture("potted_orange_osmanthus_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_WHITE_OSMANTHUS_SAPLING.get(), models().singleTexture("potted_white_osmanthus_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_GOLDEN_GINKGO_SAPLING.get(), models().singleTexture("potted_golden_ginkgo_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_GREEN_GINKGO_SAPLING.get(), models().singleTexture("potted_green_ginkgo_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_YELLOW_CHINESE_PARASOL_SAPLING.get(), models().singleTexture("potted_yellow_chinese_parasol_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_GREEN_CHINESE_PARASOL_SAPLING.get(), models().singleTexture("potted_green_chinese_parasol_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_DOVE_TREE_SAPLING.get(), models().singleTexture("potted_dove_tree_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_CHINABERRY_SAPLING.get(), models().singleTexture("potted_chinaberry_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_DESERT_POPLAR_SAPLING.get(), models().singleTexture("potted_desert_poplar_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_CRAPE_MYRTLE_SAPLING.get(), models().singleTexture("potted_crape_myrtle_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_RED_CRAPE_MYRTLE_SAPLING.get(), models().singleTexture("potted_red_crape_myrtle_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_PINK_CRAPE_MYRTLE_SAPLING.get(), models().singleTexture("potted_pink_crape_myrtle_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_WHITE_CRAPE_MYRTLE_SAPLING.get(), models().singleTexture("potted_white_crape_myrtle_sapling", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_CHRYSANTHEMUM.get(), models().singleTexture("potted_chrysanthemum", new ResourceLocation("flower_pot_cross"), "plant",
                new ResourceLocation(MoreOrnPlants.MOD_ID, "block/potted_chrysanthemum")).renderType("cutout"));
        flowerBlock(ModBlocks.XIHU_LIUYUE);
        simpleBlock(ModBlocks.POTTED_XIHU_LIUYUE.get(), models().singleTexture("potted_xihu_liuyue", new ResourceLocation("flower_pot_cross"), "plant",
                new ResourceLocation(MoreOrnPlants.MOD_ID, "block/potted_xihu_liuyue")).renderType("cutout"));
        flowerBlock(ModBlocks.GOLD_BACKED_SCARLET_MUM);
        simpleBlock(ModBlocks.POTTED_GOLD_BACKED_SCARLET_MUM.get(), models().singleTexture("potted_gold_backed_scarlet_mum", new ResourceLocation("flower_pot_cross"), "plant",
                new ResourceLocation(MoreOrnPlants.MOD_ID, "block/potted_gold_backed_scarlet_mum")).renderType("cutout"));
        flowerBlock(ModBlocks.WHITE_CHRYSANTHEMUM);
        simpleBlock(ModBlocks.POTTED_WHITE_CHRYSANTHEMUM.get(), models().singleTexture("potted_white_chrysanthemum", new ResourceLocation("flower_pot_cross"), "plant",
                new ResourceLocation(MoreOrnPlants.MOD_ID, "block/potted_white_chrysanthemum")).renderType("cutout"));
        flowerBlock(ModBlocks.BLACK_CHRYSANTHEMUM);
        simpleBlock(ModBlocks.POTTED_BLACK_CHRYSANTHEMUM.get(), models().singleTexture("potted_black_chrysanthemum", new ResourceLocation("flower_pot_cross"), "plant",
                new ResourceLocation(MoreOrnPlants.MOD_ID, "block/potted_black_chrysanthemum")).renderType("cutout"));
        flowerBlock(ModBlocks.GREEN_CHRYSANTHEMUM);
        simpleBlock(ModBlocks.POTTED_GREEN_CHRYSANTHEMUM.get(), models().singleTexture("potted_green_chrysanthemum", new ResourceLocation("flower_pot_cross"), "plant",
                new ResourceLocation(MoreOrnPlants.MOD_ID, "block/potted_green_chrysanthemum")).renderType("cutout"));
        flowerBlock(ModBlocks.PURPLE_CHRYSANTHEMUM);
        simpleBlock(ModBlocks.POTTED_PURPLE_CHRYSANTHEMUM.get(), models().singleTexture("potted_purple_chrysanthemum", new ResourceLocation("flower_pot_cross"), "plant",
                new ResourceLocation(MoreOrnPlants.MOD_ID, "block/potted_purple_chrysanthemum")).renderType("cutout"));
        flowerBlock(ModBlocks.VIOLET_PINK_CHRYSANTHEMUM);
        simpleBlock(ModBlocks.POTTED_VIOLET_PINK_CHRYSANTHEMUM.get(), models().singleTexture("potted_violet_pink_chrysanthemum", new ResourceLocation("flower_pot_cross"), "plant",
                new ResourceLocation(MoreOrnPlants.MOD_ID, "block/potted_violet_pink_chrysanthemum")).renderType("cutout"));
        flowerBlock(ModBlocks.PINK_CHRYSANTHEMUM);
        simpleBlock(ModBlocks.POTTED_PINK_CHRYSANTHEMUM.get(), models().singleTexture("potted_pink_chrysanthemum", new ResourceLocation("flower_pot_cross"), "plant",
                new ResourceLocation(MoreOrnPlants.MOD_ID, "block/potted_pink_chrysanthemum")).renderType("cutout"));
        flowerBlock(ModBlocks.LIGHT_PINK_CHRYSANTHEMUM);
        simpleBlock(ModBlocks.POTTED_LIGHT_PINK_CHRYSANTHEMUM.get(), models().singleTexture("potted_light_pink_chrysanthemum", new ResourceLocation("flower_pot_cross"), "plant",
                new ResourceLocation(MoreOrnPlants.MOD_ID, "block/potted_light_pink_chrysanthemum")).renderType("cutout"));
        ...
        simpleBlock(ModBlocks.POTTED_LIGHT_PINK_PEONY.get(), models().singleTexture("potted_light_pink_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.LIGHT_PINK_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.VIOLET_PINK_PEONY);
        simpleBlock(ModBlocks.POTTED_VIOLET_PINK_PEONY.get(), models().singleTexture("potted_violet_pink_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.VIOLET_PINK_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.PINK_PEONY);
        simpleBlock(ModBlocks.POTTED_PINK_PEONY.get(), models().singleTexture("potted_pink_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.PINK_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.RED_PEONY);
        simpleBlock(ModBlocks.POTTED_RED_PEONY.get(), models().singleTexture("potted_red_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.RED_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.LIGHT_RED_PEONY);
        simpleBlock(ModBlocks.POTTED_LIGHT_RED_PEONY.get(), models().singleTexture("potted_light_red_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.LIGHT_RED_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.INK_RED_PEONY);
        simpleBlock(ModBlocks.POTTED_INK_RED_PEONY.get(), models().singleTexture("potted_ink_red_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.INK_RED_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.VERMILION_PEONY);
        simpleBlock(ModBlocks.POTTED_VERMILION_PEONY.get(), models().singleTexture("potted_vermilion_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.VERMILION_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.PURPLE_PEONY);
        simpleBlock(ModBlocks.POTTED_PURPLE_PEONY.get(), models().singleTexture("potted_purple_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.PURPLE_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.LIGHT_PURPLE_PEONY);
        simpleBlock(ModBlocks.POTTED_LIGHT_PURPLE_PEONY.get(), models().singleTexture("potted_light_purple_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.LIGHT_PURPLE_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.INK_PURPLE_PEONY);
        simpleBlock(ModBlocks.POTTED_INK_PURPLE_PEONY.get(), models().singleTexture("potted_ink_purple_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.INK_PURPLE_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.VIOLET_PEONY);
        simpleBlock(ModBlocks.POTTED_VIOLET_PEONY.get(), models().singleTexture("potted_violet_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.VIOLET_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.YELLOW_PEONY);
        simpleBlock(ModBlocks.POTTED_YELLOW_PEONY.get(), models().singleTexture("potted_yellow_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.YELLOW_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.LIGHT_YELLOW_PEONY);
        simpleBlock(ModBlocks.POTTED_LIGHT_YELLOW_PEONY.get(), models().singleTexture("potted_light_yellow_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.LIGHT_YELLOW_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.OCHRE_YELLOW_PEONY);
        simpleBlock(ModBlocks.POTTED_OCHRE_YELLOW_PEONY.get(), models().singleTexture("potted_ochre_yellow_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.OCHRE_YELLOW_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.GOLDEN_PEONY);
        simpleBlock(ModBlocks.POTTED_GOLDEN_PEONY.get(), models().singleTexture("potted_golden_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.GOLDEN_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.WHITE_PEONY);
        simpleBlock(ModBlocks.POTTED_WHITE_PEONY.get(), models().singleTexture("potted_white_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.WHITE_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.INK_PEONY);
        simpleBlock(ModBlocks.POTTED_INK_PEONY.get(), models().singleTexture("potted_ink_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.INK_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.BLUE_PEONY);
        simpleBlock(ModBlocks.POTTED_BLUE_PEONY.get(), models().singleTexture("potted_blue_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.BLUE_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.GREEN_PEONY);
        simpleBlock(ModBlocks.POTTED_GREEN_PEONY.get(), models().singleTexture("potted_green_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.GREEN_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.COLORFUL_PEONY);
        simpleBlock(ModBlocks.POTTED_COLORFUL_PEONY.get(), models().singleTexture("potted_colorful_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.COLORFUL_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.LIGHT_COLORFUL_PEONY);
        simpleBlock(ModBlocks.POTTED_LIGHT_COLORFUL_PEONY.get(), models().singleTexture("potted_light_colorful_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.LIGHT_COLORFUL_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.INK_COLORFUL_PEONY);
        simpleBlock(ModBlocks.POTTED_INK_COLORFUL_PEONY.get(), models().singleTexture("potted_ink_colorful_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.INK_COLORFUL_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.RED_WHITE_PEONY);
        simpleBlock(ModBlocks.POTTED_RED_WHITE_PEONY.get(), models().singleTexture("potted_red_white_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.RED_WHITE_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.PINK_WHITE_PEONY);
        simpleBlock(ModBlocks.POTTED_PINK_WHITE_PEONY.get(), models().singleTexture("potted_pink_white_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.PINK_WHITE_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.YELLOW_WHITE_PEONY);
        simpleBlock(ModBlocks.POTTED_YELLOW_WHITE_PEONY.get(), models().singleTexture("potted_yellow_white_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.YELLOW_WHITE_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.PURPLE_WHITE_PEONY);
        simpleBlock(ModBlocks.POTTED_PURPLE_WHITE_PEONY.get(), models().singleTexture("potted_purple_white_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.PURPLE_WHITE_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.WU_HUA_LONG_YU_PEONY);
        simpleBlock(ModBlocks.POTTED_WU_HUA_LONG_YU_PEONY.get(), models().singleTexture("potted_wu_hua_long_yu_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.WU_HUA_LONG_YU_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.MAUVE_PEONY);
        simpleBlock(ModBlocks.POTTED_MAUVE_PEONY.get(), models().singleTexture("potted_mauve_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.MAUVE_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CAMELLIA);
        simpleBlock(ModBlocks.POTTED_CAMELLIA.get(), models().singleTexture("potted_camellia", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CAMELLIA.get())).renderType("cutout"));
        flowerBlock(ModBlocks.PINK_CAMELLIA);
        simpleBlock(ModBlocks.POTTED_PINK_CAMELLIA.get(), models().singleTexture("potted_pink_camellia", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.PINK_CAMELLIA.get())).renderType("cutout"));
        flowerBlock(ModBlocks.WHITE_CAMELLIA);
        simpleBlock(ModBlocks.POTTED_WHITE_CAMELLIA.get(), models().singleTexture("potted_white_camellia", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_CHINESE_NARCISSUS.get(), models().singleTexture("potted_chinese_narcissus", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CHINESE_NARCISSUS.get())).renderType("cutout"));
        flowerBlock(ModBlocks.GOLDEN_CHINESE_NARCISSUS);
        simpleBlock(ModBlocks.POTTED_GOLDEN_CHINESE_NARCISSUS.get(), models().singleTexture("potted_golden_chinese_narcissus", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.GOLDEN_CHINESE_NARCISSUS.get())).renderType("cutout"));
        flowerBlock(ModBlocks.WHITE_MOTH_ORCHID);
        simpleBlock(ModBlocks.POTTED_WHITE_MOTH_ORCHID.get(), models().singleTexture("potted_white_moth_orchid", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.WHITE_MOTH_ORCHID.get())).renderType("cutout"));
        flowerBlock(ModBlocks.PINK_MOTH_ORCHID);
        simpleBlock(ModBlocks.POTTED_PINK_MOTH_ORCHID.get(), models().singleTexture("potted_pink_moth_orchid", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.PINK_MOTH_ORCHID.get())).renderType("cutout"));
        flowerBlock(ModBlocks.PURPLE_MOTH_ORCHID);
        simpleBlock(ModBlocks.POTTED_PURPLE_MOTH_ORCHID.get(), models().singleTexture("potted_purple_moth_orchid", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_PINK_CHINESE_ROSE.get(), models().singleTexture("potted_pink_chinese_rose", new ResourceLocation("flower_pot_cross"), "plant",
                new ResourceLocation(MoreOrnPlants.MOD_ID, "block/potted_pink_chinese_rose")).renderType("cutout"));
        simpleBlock(ModBlocks.POTTED_YELLOW_CHINESE_ROSE.get(), models().singleTexture("potted_yellow_chinese_rose", new ResourceLocation("flower_pot_cross"), "plant",
                new ResourceLocation(MoreOrnPlants.MOD_ID, "block/potted_yellow_chinese_rose")).renderType("cutout"));
        simpleBlock(ModBlocks.POTTED_WHITE_CHINESE_ROSE.get(), models().singleTexture("potted_white_chinese_rose", new ResourceLocation("flower_pot_cross"), "plant",
                new ResourceLocation(MoreOrnPlants.MOD_ID, "block/potted_white_chinese_rose")).renderType("cutout"));
        simpleBlock(ModBlocks.POTTED_PURPLE_CHINESE_ROSE.get(), models().singleTexture("potted_purple_chinese_rose", new ResourceLocation("flower_pot_cross"), "plant",
                new ResourceLocation(MoreOrnPlants.MOD_ID, "block/potted_purple_chinese_rose")).renderType("cutout"));
        simpleBlock(ModBlocks.POTTED_RED_PINK_CHINESE_ROSE.get(), models().singleTexture("potted_red_pink_chinese_rose", new ResourceLocation("flower_pot_cross"), "plant",
                new ResourceLocation(MoreOrnPlants.MOD_ID, "block/potted_red_pink_chinese_rose")).renderType("cutout"));
        simpleBlock(ModBlocks.POTTED_RED_YELLOW_CHINESE_ROSE.get(), models().singleTexture("potted_red_yellow_chinese_rose", new ResourceLocation("flower_pot_cross"), "plant",
                new ResourceLocation(MoreOrnPlants.MOD_ID, "block/potted_red_yellow_chinese_rose")).renderType("cutout"));
        simpleBlock(ModBlocks.POTTED_RED_WHITE_CHINESE_ROSE.get(), models().singleTexture("potted_red_white_chinese_rose", new ResourceLocation("flower_pot_cross"), "plant",
                new ResourceLocation(MoreOrnPlants.MOD_ID, "block/potted_red_white_chinese_rose")).renderType("cutout"));
        simpleBlock(ModBlocks.POTTED_PINK_WHITE_CHINESE_ROSE.get(), models().singleTexture("potted_pink_white_chinese_rose", new ResourceLocation("flower_pot_cross"), "plant",
                new ResourceLocation(MoreOrnPlants.MOD_ID, "block/potted_pink_white_chinese_rose")).renderType("cutout"));
        simpleBlock(ModBlocks.POTTED_YELLOW_WHITE_CHINESE_ROSE.get(), models().singleTexture("potted_yellow_white_chinese_rose", new ResourceLocation("flower_pot_cross"), "plant",
                new ResourceLocation(MoreOrnPlants.MOD_ID, "block/potted_yellow_white_chinese_rose")).renderType("cutout"));
        simpleBlock(ModBlocks.POTTED_PURPLE_WHITE_CHINESE_ROSE.get(), models().singleTexture("potted_purple_white_chinese_rose", new ResourceLocation("flower_pot_cross"), "plant",
                new ResourceLocation(MoreOrnPlants.MOD_ID, "block/potted_purple_white_chinese_rose")).renderType("cutout"));
        simpleBlock(ModBlocks.POTTED_BAOHUA_CHINESE_ROSE.get(), models().singleTexture("potted_baohua_chinese_rose", new ResourceLocation("flower_pot_cross"), "plant",
                new ResourceLocation(MoreOrnPlants.MOD_ID, "block/potted_baohua_chinese_rose")).renderType("cutout"));
        tallCrossBlock(ModBlocks.WINTERSWEET);
        simpleBlock(ModBlocks.POTTED_WINTERSWEET.get(), models().singleTexture("potted_wintersweet", new ResourceLocation("flower_pot_cross"), "plant",
        ...
        simpleBlock(ModBlocks.POTTED_CUT_LIGHT_PINK_PEONY.get(), models().singleTexture("potted_cut_light_pink_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_LIGHT_PINK_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_VIOLET_PINK_PEONY);
        simpleBlock(ModBlocks.POTTED_CUT_VIOLET_PINK_PEONY.get(), models().singleTexture("potted_cut_violet_pink_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_VIOLET_PINK_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_RED_PEONY);
        simpleBlock(ModBlocks.POTTED_CUT_RED_PEONY.get(), models().singleTexture("potted_cut_red_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_RED_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_LIGHT_RED_PEONY);
        simpleBlock(ModBlocks.POTTED_CUT_LIGHT_RED_PEONY.get(), models().singleTexture("potted_cut_light_red_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_LIGHT_RED_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_INK_RED_PEONY);
        simpleBlock(ModBlocks.POTTED_CUT_INK_RED_PEONY.get(), models().singleTexture("potted_cut_ink_red_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_INK_RED_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_PURPLE_PEONY);
        simpleBlock(ModBlocks.POTTED_CUT_PURPLE_PEONY.get(), models().singleTexture("potted_cut_purple_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_PURPLE_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_LIGHT_PURPLE_PEONY);
        simpleBlock(ModBlocks.POTTED_CUT_LIGHT_PURPLE_PEONY.get(), models().singleTexture("potted_cut_light_purple_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_LIGHT_PURPLE_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_INK_PURPLE_PEONY);
        simpleBlock(ModBlocks.POTTED_CUT_INK_PURPLE_PEONY.get(), models().singleTexture("potted_cut_ink_purple_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_INK_PURPLE_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_YELLOW_PEONY);
        simpleBlock(ModBlocks.POTTED_CUT_YELLOW_PEONY.get(), models().singleTexture("potted_cut_yellow_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_YELLOW_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_LIGHT_YELLOW_PEONY);
        simpleBlock(ModBlocks.POTTED_CUT_LIGHT_YELLOW_PEONY.get(), models().singleTexture("potted_cut_light_yellow_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_LIGHT_YELLOW_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_OCHRE_YELLOW_PEONY);
        simpleBlock(ModBlocks.POTTED_CUT_OCHRE_YELLOW_PEONY.get(), models().singleTexture("potted_cut_ochre_yellow_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_OCHRE_YELLOW_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_WHITE_PEONY);
        simpleBlock(ModBlocks.POTTED_CUT_WHITE_PEONY.get(), models().singleTexture("potted_cut_white_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_WHITE_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_INK_PEONY);
        simpleBlock(ModBlocks.POTTED_CUT_INK_PEONY.get(), models().singleTexture("potted_cut_ink_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_INK_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_BLUE_PEONY);
        simpleBlock(ModBlocks.POTTED_CUT_BLUE_PEONY.get(), models().singleTexture("potted_cut_blue_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_BLUE_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_GREEN_PEONY);
        simpleBlock(ModBlocks.POTTED_CUT_GREEN_PEONY.get(), models().singleTexture("potted_cut_green_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_GREEN_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_WU_HUA_LONG_YU_PEONY);
        simpleBlock(ModBlocks.POTTED_CUT_WU_HUA_LONG_YU_PEONY.get(), models().singleTexture("potted_cut_wu_hua_long_yu_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_WU_HUA_LONG_YU_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_MAUVE_PEONY);
        simpleBlock(ModBlocks.POTTED_CUT_MAUVE_PEONY.get(), models().singleTexture("potted_cut_mauve_peony", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_MAUVE_PEONY.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_CHINESE_ROSE);
        simpleBlock(ModBlocks.POTTED_CUT_CHINESE_ROSE.get(), models().singleTexture("potted_cut_chinese_rose", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_CHINESE_ROSE.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_PINK_ROSE);
        simpleBlock(ModBlocks.POTTED_CUT_PINK_ROSE.get(), models().singleTexture("potted_cut_pink_rose", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_PINK_ROSE.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_YELLOW_ROSE);
        simpleBlock(ModBlocks.POTTED_CUT_YELLOW_ROSE.get(), models().singleTexture("potted_cut_yellow_rose", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_YELLOW_ROSE.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_WHITE_ROSE);
        simpleBlock(ModBlocks.POTTED_CUT_WHITE_ROSE.get(), models().singleTexture("potted_cut_white_rose", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_WHITE_ROSE.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_PURPLE_ROSE);
        simpleBlock(ModBlocks.POTTED_CUT_PURPLE_ROSE.get(), models().singleTexture("potted_cut_purple_rose", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_PURPLE_ROSE.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_BAOHUA_CHINESE_ROSE);
        simpleBlock(ModBlocks.POTTED_CUT_BAOHUA_CHINESE_ROSE.get(), models().singleTexture("potted_cut_baohua_chinese_rose", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_BAOHUA_CHINESE_ROSE.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_WINTERSWEET);
        simpleBlock(ModBlocks.POTTED_CUT_WINTERSWEET.get(), models().singleTexture("potted_cut_wintersweet", new ResourceLocation("flower_pot_cross"), "plant",
                blockTexture(ModBlocks.CUT_WINTERSWEET.get())).renderType("cutout"));
        flowerBlock(ModBlocks.CUT_COTTON_ROSE);
        simpleBlock(ModBlocks.POTTED_CUT_COTTON_ROSE.get(), models().singleTexture("potted_cut_cotton_rose", new ResourceLocation("flower_pot_cross"), "plant",
    ...
    private void wisteriaBlock(RegistryObject<Block> blockRegistryObject) {
        String baseName = null;
        if (blockRegistryObject.getId() != null) {
            baseName = blockRegistryObject.getId().getPath();
        }
    ...
    private void wisteriaPlantBlock(RegistryObject<Block> blockRegistryObject) {
        String baseName = null;
        if (blockRegistryObject.getId() != null) {
            baseName = blockRegistryObject.getId().getPath();
        }
    ...
    private void saplingBlock(RegistryObject<Block> blockRegistryObject, boolean tinted) {
        if (tinted) {
            ...
            if (baseName != null) {
                textureName = baseName.replace("_sapling", "_stage0");
            }
            simpleBlock(blockRegistryObject.get(),
                    models().withExistingParent(Objects.requireNonNull(ForgeRegistries.BLOCKS.getKey(blockRegistryObject.get())).getPath(),
    ...
    private void facingFruitBlock(RegistryObject<Block> blockRegistryObject) {
    ...
    private void fruitPileBlock(RegistryObject<Block> block, String parentModelPath, String textureKey, String texture) {
    ...
    private void pottedBambooBlock(RegistryObject<Block> pottedBlock) {
        String baseName = null;
        if (pottedBlock.getId() != null) {
            baseName = pottedBlock.getId().getPath();
        }
        String bambooType = null;
        if (baseName != null) {
            bambooType = baseName.replace("potted_", "");
        }
    ...
    private void hardyBananaBlock() {
        String baseName = null;
        if (ModBlocks.HARDY_BANANA.getId() != null) {
            baseName = ModBlocks.HARDY_BANANA.getId().getPath();
        }
