...
@OnlyIn(Dist.CLIENT)
public class PeachParticle extends TextureSheetParticle {
    ...
    public PeachParticle(ClientLevel pLevel, double pX, double pY, double pZ, SpriteSet pSpriteSet) {
        ...
        float f = this.random.nextBoolean() ? 0.06F : 0.09F;
        this.quadSize = f;
        this.setSize(f, f);
        this.friction = 1.0F;
    }
