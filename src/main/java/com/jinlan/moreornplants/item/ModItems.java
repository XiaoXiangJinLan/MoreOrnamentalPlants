...
public class ModItems {
    ...
    public static final DeferredItem<Item> ORNAMENTAL_PEACH_PETALS =
            ITEMS.register("ornamental_peach_petals", () -> new PlaceOnWaterBlockItem(ModBlocks.ORNAMENTAL_PEACH_PETALS.get(), new Item.Properties()));
    public static final DeferredItem<Item> WILD_PEACH_PETALS =
            ITEMS.register("wild_peach_petals", () -> new PlaceOnWaterBlockItem(ModBlocks.WILD_PEACH_PETALS.get(), new Item.Properties()));
    public static final DeferredItem<Item> CHINESE_PARASOL_LEAF_0 =
            ITEMS.register("chinese_parasol_leaf_0", () -> new PlaceOnWaterBlockItem(ModBlocks.CHINESE_PARASOL_LEAF_0.get(), new Item.Properties()));
    public static final DeferredItem<Item> CHINESE_PARASOL_LEAF_1 =
            ITEMS.register("chinese_parasol_leaf_1", () -> new PlaceOnWaterBlockItem(ModBlocks.CHINESE_PARASOL_LEAF_1.get(), new Item.Properties()));
    public static final DeferredItem<Item> SWEETGUM_LEAF_0 =
            ITEMS.register("sweetgum_leaf_0", () -> new PlaceOnWaterBlockItem(ModBlocks.SWEETGUM_LEAF_0.get(), new Item.Properties()));
    public static final DeferredItem<Item> SWEETGUM_LEAF_1 =
            ITEMS.register("sweetgum_leaf_1", () -> new PlaceOnWaterBlockItem(ModBlocks.SWEETGUM_LEAF_1.get(), new Item.Properties()));
    public static final DeferredItem<Item> GINKGO_LEAF =
            ITEMS.register("ginkgo_leaf", () -> new PlaceOnWaterBlockItem(ModBlocks.GINKGO_LEAF.get(), new Item.Properties()));
    ...
    public static final DeferredItem<Item> ZIYING_HOE =
            ITEMS.register("ziying_hoe", () -> new HoeItem(ModTiers.ZIYING, new Item.Properties().attributes(HoeItem.createAttributes(ModTiers.ZIYING, -2.0F, -1.0F))));
    public static final DeferredItem<Item> ZIYING_SHOVEL =
            ITEMS.register("ziying_shovel", () -> new ShovelItem(ModTiers.ZIYING, new Item.Properties().attributes(ShovelItem.createAttributes(ModTiers.ZIYING, 1.5F, -3.0F))));
    public static final DeferredItem<Item> SUYU_SWORD =
            ITEMS.register("suyu_sword", () -> new SuyuSwordItem(ModTiers.SUYU, new Item.Properties().attributes(ModRangeSwordItem.createAttributes(ModTiers.SUYU, 3, -1.6F, 1.0F))));
    ...
    public static final DeferredItem<Item> SUYU_HOE =
            ITEMS.register("suyu_hoe", () -> new HoeItem(ModTiers.SUYU, new Item.Properties().attributes(HoeItem.createAttributes(ModTiers.SUYU, -2.0F, -0.8F))));
    public static final DeferredItem<Item> SUYU_SHOVEL =
            ITEMS.register("suyu_shovel", () -> new ShovelItem(ModTiers.SUYU, new Item.Properties().attributes(ShovelItem.createAttributes(ModTiers.SUYU, 1.5F, -2.6F))));
    public static final DeferredItem<Item> ZIYU_YUANYANG_SWORD =
            ITEMS.register("ziyu_yuanyang_sword", () -> new ZiyuSwordItem(ModTiers.ZIYU_YUANYANG, new Item.Properties().attributes(ModRangeSwordItem.createAttributes(ModTiers.ZIYU_YUANYANG, 3, -2.4F, 1.0F))));
    ...
    public static final DeferredItem<Item> ZIYU_YUANYANG_HOE =
            ITEMS.register("ziyu_yuanyang_hoe", () -> new HoeItem(ModTiers.ZIYU_YUANYANG, new Item.Properties().attributes(HoeItem.createAttributes(ModTiers.ZIYU_YUANYANG, -2.0F, -1.0F))));
    public static final DeferredItem<Item> ZIYU_YUANYANG_SHOVEL =
            ITEMS.register("ziyu_yuanyang_shovel", () -> new ShovelItem(ModTiers.ZIYU_YUANYANG, new Item.Properties().attributes(ShovelItem.createAttributes(ModTiers.ZIYU_YUANYANG, 1.5F, -3.0F))));
    ...
    public static final DeferredItem<Item> BAIHUA_SWORD =
            ITEMS.register("baihua_sword", () -> new BaihuaSwordItem(ModTiers.BAIHUA, new Item.Properties().attributes(SwordItem.createAttributes(ModTiers.BAIHUA, 3, -2.0F))));
    ...
    public static final DeferredItem<Item> BAMBOO_SHOOTS_SOUP =
            ITEMS.register("bamboo_shoots_soup", () -> new FoodBlockItem(ModBlocks.BAMBOO_SHOOTS_SOUP.get(), new Item.Properties().food(ModFoods.BAMBOO_SHOOTS_SOUP)));
    ...
    public static final DeferredItem<Item> LOTUS_ROOT_SOUP =
            ITEMS.register("lotus_root_soup", () -> new FoodBlockItem(ModBlocks.LOTUS_ROOT_SOUP.get(), new Item.Properties().food(ModFoods.LOTUS_ROOT_SOUP)));
    ...
    public static final DeferredItem<Item> GOLDEN_CRABAPPLE =
            ITEMS.register("golden_crabapple", () -> new FoodBlockItem(ModBlocks.GOLDEN_CRABAPPLE.get(), new Item.Properties().rarity(Rarity.RARE).food(ModFoods.GOLDEN_CRABAPPLE)));
    ...
    public static final DeferredItem<Item> GOLDEN_MEI =
            ITEMS.register("golden_mei", () -> new FoodBlockItem(ModBlocks.GOLDEN_MEI.get(), new Item.Properties().food(ModFoods.GOLDEN_MEI)));
