...
public class RedWeepingMeiTreeGrower extends AbstractTreeGrower {
    @Nullable
    @Override
    protected ResourceKey<ConfiguredFeature<?, ?>> getConfiguredFeature(@NotNull RandomSource pRandom, boolean pHasFlowers) {
        return pHasFlowers ? ModTreeFeatures.RED_WEEPING_MEI_BEES : ModTreeFeatures.RED_WEEPING_MEI;
    }
}
