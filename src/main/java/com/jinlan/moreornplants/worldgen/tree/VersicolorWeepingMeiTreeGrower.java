...
public class VersicolorWeepingMeiTreeGrower extends AbstractTreeGrower {
    @Nullable
    @Override
    protected ResourceKey<ConfiguredFeature<?, ?>> getConfiguredFeature(@NotNull RandomSource pRandom, boolean pHasFlowers) {
        return pHasFlowers ? ModTreeFeatures.VERSICOLOR_WEEPING_MEI_BEES : ModTreeFeatures.VERSICOLOR_WEEPING_MEI;
    }
}
