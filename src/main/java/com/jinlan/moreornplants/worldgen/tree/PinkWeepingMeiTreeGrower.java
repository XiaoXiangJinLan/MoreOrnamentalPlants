...
public class PinkWeepingMeiTreeGrower extends AbstractTreeGrower {
    @Nullable
    @Override
    protected ResourceKey<ConfiguredFeature<?, ?>> getConfiguredFeature(@NotNull RandomSource pRandom, boolean pHasFlowers) {
        return pHasFlowers ? ModTreeFeatures.PINK_WEEPING_MEI_BEES : ModTreeFeatures.PINK_WEEPING_MEI;
    }
}