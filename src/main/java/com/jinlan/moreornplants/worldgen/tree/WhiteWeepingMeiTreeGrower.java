...
public class WhiteWeepingMeiTreeGrower extends AbstractTreeGrower {
    @Nullable
    @Override
    protected ResourceKey<ConfiguredFeature<?, ?>> getConfiguredFeature(@NotNull RandomSource pRandom, boolean pHasFlowers) {
        return pHasFlowers ? ModTreeFeatures.WHITE_WEEPING_MEI_BEES : ModTreeFeatures.WHITE_WEEPING_MEI;
    }
}
