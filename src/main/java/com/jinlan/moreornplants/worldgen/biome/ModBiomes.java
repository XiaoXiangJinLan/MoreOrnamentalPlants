...
public class ModBiomes {
    ...
    public static final ResourceKey<Biome> HANDONG_LAYUE = ResourceKey.create(Registries.BIOME,
            ResourceLocation.parse(MoreOrnPlants.MODID + ":" + "handong_layue"));
    ...
    public static final ResourceKey<Biome> TAMARISK_FIELDS = ResourceKey.create(Registries.BIOME,
            ResourceLocation.parse(MoreOrnPlants.MODID + ":" + "tamarisk_fields"));
    public static final ResourceKey<Biome> GOLD_COUNTRY = ResourceKey.create(Registries.BIOME,
            ResourceLocation.parse(MoreOrnPlants.MODID + ":" + "gold_country"));
    ...
    public static final ResourceKey<Biome> DONGLI_SCENERY = ResourceKey.create(Registries.BIOME,
            ResourceLocation.parse(MoreOrnPlants.MODID + ":" + "dongli_scenery"));
    public static final ResourceKey<Biome> CRAPE_MYRTLE_GARDEN = ResourceKey.create(Registries.BIOME,
            ResourceLocation.parse(MoreOrnPlants.MODID + ":" + "crape_myrtle_garden"));
    ...
    private static Biome coldBiome(BootstrapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
    ...
    private static Biome coloredForest(BootstrapContext<Biome> context, boolean isColored) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
    ...
    private static Biome desertBiome(BootstrapContext<Biome> context, boolean isGold, boolean isTamarisk) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
    ...
    private static Biome flowersFields(BootstrapContext<Biome> context, boolean isCrapeMyrtle) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
    ...
    private static Biome flowersWoods(BootstrapContext<Biome> context, boolean isPear) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
    ...
    private static Biome wisteriaBiome(BootstrapContext<Biome> context, boolean isWhite, boolean isBlue) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
    ...
    private static Biome purpleCloud(BootstrapContext<Biome> context) {
        ...
        return new Biome.BiomeBuilder()
                ...
                .generationSettings(biomeBuilder.build()).mobSpawnSettings(spawnBuilder.build())
                .specialEffects((new BiomeSpecialEffects.Builder())
                        .waterColor(4159204).waterFogColor(329011).skyColor(0xCAA8E5).fogColor(0xEFD7F7).foliageColorOverride(0xD06E96).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build())
                .build();
    }
