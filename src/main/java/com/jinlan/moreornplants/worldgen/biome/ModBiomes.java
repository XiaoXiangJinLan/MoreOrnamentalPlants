...
public class ModBiomes {
    ...
    public static final ResourceKey<Biome> FRAGRANT_SNOW_SEA = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(MoreOrnPlants.MOD_ID, "fragrant_snow_sea"));
    public static final ResourceKey<Biome> SNOW_GREETS_SPRING = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(MoreOrnPlants.MOD_ID, "snow_greets_spring"));
    public static final ResourceKey<Biome> HANDONG_LAYUE = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(MoreOrnPlants.MOD_ID, "handong_layue"));
    ...
    public static final ResourceKey<Biome> LONGEVITY_FOREST = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(MoreOrnPlants.MOD_ID, "longevity_forest"));
    ...
    public static final ResourceKey<Biome> WUTONG_FOREST = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(MoreOrnPlants.MOD_ID, "wutong_forest"));
    ...
    public static final ResourceKey<Biome> FLOWERS_FIELDS = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(MoreOrnPlants.MOD_ID, "flowers_fields"));
    public static final ResourceKey<Biome> CRABAPPLE_GROVE = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(MoreOrnPlants.MOD_ID, "crabapple_grove"));
    ...
    public static final ResourceKey<Biome> RED_CAMELLIA_VALLEY = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(MoreOrnPlants.MOD_ID, "red_camellia_valley"));
    public static final ResourceKey<Biome> PINK_CAMELLIA_VALLEY = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(MoreOrnPlants.MOD_ID, "pink_camellia_valley"));
    ...
    public static final ResourceKey<Biome> TAMARISK_FIELDS = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(MoreOrnPlants.MOD_ID, "tamarisk_fields"));
    public static final ResourceKey<Biome> GOLD_COUNTRY = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(MoreOrnPlants.MOD_ID, "gold_country"));
    ...
    public static final ResourceKey<Biome> DONGLI_SCENERY = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(MoreOrnPlants.MOD_ID, "dongli_scenery"));
    public static final ResourceKey<Biome> CRAPE_MYRTLE_GARDEN = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(MoreOrnPlants.MOD_ID, "crape_myrtle_garden"));
    ...
    public static final ResourceKey<Biome> LOTUS_RIVER = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(MoreOrnPlants.MOD_ID, "lotus_river"));
    public static final ResourceKey<Biome> AUTUMN_RIVER = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(MoreOrnPlants.MOD_ID, "autumn_river"));
    ...
    public static final ResourceKey<Biome> THE_APRICOT_SPRING_PLATEAU = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(MoreOrnPlants.MOD_ID, "the_apricot_spring_plateau"));
    ...
    public static void bootstrap(BootstapContext<Biome> context) {
        ...
        context.register(HANDONG_LAYUE, coldBiome(context));
        ...
        context.register(DESERT_POPLAR_WOODS, desertBiome(context, false, false));
        context.register(TAMARISK_FIELDS, desertBiome(context, false, true));
        context.register(GOLD_COUNTRY, desertBiome(context, true, false));
        context.register(CHINESE_ROSE_FIELDS, roseFields(context, false));
        context.register(SWEETGUM_WOODS, roseFields(context, true));
        context.register(DONGLI_SCENERY, flowersFields(context, false));
        context.register(CRAPE_MYRTLE_GARDEN, flowersFields(context, true));
        context.register(CHINABERRY_WOODS, flowersWoods(context, false));
        context.register(SNOW_WOODS, flowersWoods(context, true));
    ...
    private static Biome meiForest(BootstapContext<Biome> context, boolean isRed, boolean isSpring) {
    ...
    private static Biome coldBiome(BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        ...
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityType.RABBIT, 10, 2, 3))
                .addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityType.WOLF, 2, 2, 4))
                .addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.STRAY, 80, 4, 4));

        BiomeGenerationSettings.Builder biomeBuilder =
                new BiomeGenerationSettings.Builder(context.lookup(Registries.PLACED_FEATURE), context.lookup(Registries.CONFIGURED_CARVER));
        globalOverworldGeneration(biomeBuilder);
        BiomeDefaultFeatures.addMossyStoneBlock(biomeBuilder);
        biomeBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.STONE_PLACED);
        BiomeDefaultFeatures.addDefaultOres(biomeBuilder);
        BiomeDefaultFeatures.addDefaultSoftDisks(biomeBuilder);
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.WINTERSWEET_COLD);
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.GRASS_FERN_1);
        return new Biome.BiomeBuilder()
                .hasPrecipitation(true).temperature(-0.4f).downfall(0.4f)
                .generationSettings(biomeBuilder.build()).mobSpawnSettings(spawnBuilder.build())
                .specialEffects((new BiomeSpecialEffects.Builder())
                        .waterColor(4159204).waterFogColor(329011).skyColor(8560639).fogColor(12638463).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build())
                .build();
    ...
    private static Biome thePeachBlossomSpring(BootstapContext<Biome> context) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.ANCIENT_WILD_PEACH_PLACED);
        ...
        return new Biome.BiomeBuilder()
                ...
                .generationSettings(biomeBuilder.build()).mobSpawnSettings(spawnBuilder.build())
                .specialEffects((new BiomeSpecialEffects.Builder())
                        .waterColor(0x93A0F3).waterFogColor(0x925F9B).skyColor(0xFFCCDD).fogColor(0xFFE5EA).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build())
                .build();
    }

    private static Biome evergreenForest(BootstapContext<Biome> context, boolean isLongevity) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        ...
        if (isLongevity) {
            ...
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.CHRYSANTHEMUM_LONGEVITY_PLACED);
        } else {
    ...
    private static Biome coloredForest(BootstapContext<Biome> context, boolean isColored) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        ...
        if (isColored) {
            ...
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.YELLOW_CHINESE_PARASOL_PLACED2);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.GREEN_CHINESE_PARASOL_PLACED2);
        }
        ...
        return new Biome.BiomeBuilder()
                ...
                .generationSettings(biomeBuilder.build()).mobSpawnSettings(spawnBuilder.build())
                .specialEffects((new BiomeSpecialEffects.Builder())
                        .waterColor(4159204).waterFogColor(329011).skyColor(7972607).fogColor(12638463).grassColorOverride(isColored ? 16763904 : 0xFFAF00).foliageColorOverride(0xF58931).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build())
                .build();
    }

    private static Biome flowersGrove(BootstapContext<Biome> context, boolean isCrabapple, boolean isFields) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        ...
        if (isCrabapple) {
            ...
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.WU_HUA_LONG_YU_PEONY_GROVE);
            ...
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.LIGHT_PEONY_GROVE_PLACED);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.INK_PEONY_GROVE_PLACED);
            ...
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.CAMELLIA_GROVE_PLACED);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.PINK_CAMELLIA_GROVE_PLACED);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.WHITE_CAMELLIA_GROVE_PLACED);
            ...
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.WINTERSWEET_GROVE);
            ...
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.SMALL_BLUE_FLOWERS_GROVE_PLACED);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.SMALL_WHITE_FLOWERS_GROVE_PLACED);
            ...
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.TALL_FLOWERS_GROVE_2_PLACED);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.PEACH_PINK_PETALS_GROVE_PLACED);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.FRAGRANT_SNOW_PETALS_GROVE_PLACED);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.SPRING_PETALS_GROVE_PLACED);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.PINK_PETALS_GROVE_PLACED);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.LOTUS_PLACED);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.LOTUS_RIVER_PLACED);
        }
        if (isFields) {
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.TALL_GRASS);
        ...
        return new Biome.BiomeBuilder()
                ...
                .generationSettings(biomeBuilder.build()).mobSpawnSettings(spawnBuilder.build())
                .specialEffects((new BiomeSpecialEffects.Builder())
                        .waterColor(6141935).waterFogColor(6141935).skyColor(8103167).fogColor(12638463).foliageColorOverride(0xFFB0B0).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build())
                .build();
    }

    private static Biome camelliaValley(BootstapContext<Biome> context, boolean isRed, boolean isPink) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        BiomeDefaultFeatures.farmAnimals(spawnBuilder);
        BiomeDefaultFeatures.commonSpawns(spawnBuilder);
    ...
    private static Biome redHighlands(BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        BiomeDefaultFeatures.farmAnimals(spawnBuilder);
        BiomeDefaultFeatures.caveSpawns(spawnBuilder);
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityType.RABBIT, 4, 2, 3));
    ...
    private static Biome landBiome(BootstapContext<Biome> context, boolean isPink, boolean isWhite, boolean isPurple) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
    ...
    private static Biome wetBiome(BootstapContext<Biome> context, boolean isYunmeng) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
    ...
    private static Biome desertBiome(BootstapContext<Biome> context, boolean isGold, boolean isTamarisk) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        ...
        if (isGold) {
            ...
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.GOLDEN_BRANCHY_TAMARISK_PLACED_2);
        } else {
            ...
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.BRANCHY_TAMARISK_PLACED_4);
        }
        float t = isGold ? 1.5f : 2.0f;
        float f = isTamarisk ? 0.2f : 0.0f;
        return new Biome.BiomeBuilder()
                .hasPrecipitation(false).temperature(t).downfall(f)
                .generationSettings(biomeBuilder.build()).mobSpawnSettings(spawnBuilder.build())
                .specialEffects((new BiomeSpecialEffects.Builder())
    ...
    private static Biome flowersFields(BootstapContext<Biome> context, boolean isCrapeMyrtle) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        ...
        BiomeDefaultFeatures.addDefaultSoftDisks(biomeBuilder);
        if (isCrapeMyrtle) {
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.CRAPE_MYRTLE_TREE_GARDEN);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.RED_CRAPE_MYRTLE_TREE_GARDEN);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.PINK_CRAPE_MYRTLE_TREE_GARDEN);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.WHITE_CRAPE_MYRTLE_TREE_GARDEN);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.SMALL_CRAPE_MYRTLE_GARDEN);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.SMALL_RED_CRAPE_MYRTLE_GARDEN);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.SMALL_PINK_CRAPE_MYRTLE_GARDEN);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.SMALL_WHITE_CRAPE_MYRTLE_GARDEN);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.CRAPE_MYRTLE_GARDEN);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.RED_CRAPE_MYRTLE_GARDEN);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.PINK_CRAPE_MYRTLE_GARDEN);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.WHITE_CRAPE_MYRTLE_GARDEN);
        } else {
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.CHRYSANTHEMUM_DONGLI_PLACED);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.CHRYSANTHEMUM_DONGLI_PLACED_1);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.CHRYSANTHEMUM_DONGLI_PLACED_2);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.CHRYSANTHEMUM_DONGLI_PLACED_3);
        }
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.TALL_GRASS);
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.GRASS_PLAIN);
        ...
        return new Biome.BiomeBuilder()
                ...
                .generationSettings(biomeBuilder.build()).mobSpawnSettings(spawnBuilder.build())
                .specialEffects((new BiomeSpecialEffects.Builder())
                        .waterColor(4159204).waterFogColor(329011).skyColor(7907327).fogColor(12638463).grassColorOverride(11983713).foliageColorOverride(11983713).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build())
                .build();
    }

    private static Biome flowersWoods(BootstapContext<Biome> context, boolean isPear) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
    ...
    private static Biome miscanthusFields(BootstapContext<Biome> context, boolean isForest) {
        ...
        if (isForest) {
            ...
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.GINKGO_FOREST_FLOWER);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.LEAF_RIVER_2);
        } else {
    ...
    private static Biome plainBiome(BootstapContext<Biome> context, boolean isCrops) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
    ...
    private static Biome wisteriaBiome(BootstapContext<Biome> context, boolean isWhite, boolean isBlue) {
        ...
        BiomeDefaultFeatures.addDefaultExtraVegetation(biomeBuilder);
        if (isWhite) {
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.TALL_WHITE_WISTERIA_TREE_VALLEY);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.WHITE_WISTERIA_TREE_VALLEY);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.WHITE_MOTH_ORCHID_VALLEY_PLACED);
        } else if (isBlue) {
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.TALL_BLUE_WISTERIA_TREE_VALLEY);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.BLUE_WISTERIA_TREE_VALLEY);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.BLUE_ORCHID_VALLEY);
        } else {
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.TALL_WISTERIA_TREE_VALLEY);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.TALL_PURPLE_WISTERIA_TREE_VALLEY);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.TALL_RED_WISTERIA_TREE_VALLEY);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.WISTERIA_TREE_VALLEY);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.PURPLE_WISTERIA_TREE_VALLEY);
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.RED_WISTERIA_TREE_VALLEY);
    ...
    private static Biome purpleCloud(BootstapContext<Biome> context) {
        ...
        return new Biome.BiomeBuilder()
                ...
                .generationSettings(biomeBuilder.build()).mobSpawnSettings(spawnBuilder.build())
                .specialEffects((new BiomeSpecialEffects.Builder())
                        .waterColor(4159204).waterFogColor(329011).skyColor(0xCAA8E5).fogColor(0xD06E96).foliageColorOverride(0xD06E96).ambientMoodSound(AmbientMoodSettings.LEGACY_CAVE_SETTINGS).build())
                .build();
    }

    private static Biome riverBiome(BootstapContext<Biome> context, boolean isLotus, boolean isAutumn, boolean isSnow) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        ...
        if (isSnow) {
            ...
            biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.TALL_MUXUE_GRASS_PLACED);
        } else {
            if (isLotus) {
                biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.ORCHID_FOREST_PLACED);
                biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.LOTUS_RIVER_PLACED);
    ...
    private static Biome azaleaForest(BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        BiomeDefaultFeatures.farmAnimals(spawnBuilder);
        BiomeDefaultFeatures.commonSpawns(spawnBuilder);
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityType.RABBIT, 4, 2, 3))
    ...
    private static Biome tenMileGallery(BootstapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        BiomeDefaultFeatures.farmAnimals(spawnBuilder);
        BiomeDefaultFeatures.commonSpawns(spawnBuilder);
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityType.RABBIT, 4, 2, 3));
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.AZALEA_GALLERY);
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.PINK_CAMELLIA_GALLERY);
