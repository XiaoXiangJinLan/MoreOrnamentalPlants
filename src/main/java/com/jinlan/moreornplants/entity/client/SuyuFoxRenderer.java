...
public class SuyuFoxRenderer extends ZiyingFoxRenderer {
    private static final ResourceLocation SUYU_FOX_TEXTURE =
            new ResourceLocation(MoreOrnPlants.MOD_ID, "textures/entity/suyu_fox/suyu_fox.png");
    private static final ResourceLocation SUYU_FOX_SLEEP_TEXTURE =
            new ResourceLocation(MoreOrnPlants.MOD_ID, "textures/entity/suyu_fox/suyu_fox_sleep.png");
    private static final ResourceLocation SUYU_FOX_TAME_TEXTURE =
            new ResourceLocation(MoreOrnPlants.MOD_ID, "textures/entity/suyu_fox/suyu_fox_tame.png");
    private static final ResourceLocation SUYU_FOX_TAME_SLEEP_TEXTURE =
            new ResourceLocation(MoreOrnPlants.MOD_ID, "textures/entity/suyu_fox/suyu_fox_tame_sleep.png");
