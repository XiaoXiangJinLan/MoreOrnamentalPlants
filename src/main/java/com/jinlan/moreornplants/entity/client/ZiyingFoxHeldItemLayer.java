...
public class ZiyingFoxHeldItemLayer extends RenderLayer<ZiyingFox, ZiyingFoxModel<ZiyingFox>> {
    private final ItemInHandRenderer itemInHandRenderer;

    public ZiyingFoxHeldItemLayer(RenderLayerParent<ZiyingFox, ZiyingFoxModel<ZiyingFox>> renderer, ItemInHandRenderer itemInHandRenderer) {
        super(renderer);
