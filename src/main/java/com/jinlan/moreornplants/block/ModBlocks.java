...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> GOLDEN_MEI_LEAVES =
            registerBlock("golden_mei_leaves", () -> new GoldenMeiLeavesBlock(BlockBehaviour.Properties.copy(Blocks.CHERRY_LEAVES).mapColor(MapColor.GOLD)));
    ...
    public static final RegistryObject<Block> NEW_CAMPHOR_LEAVES =
            registerBlock("new_camphor_leaves", () -> new CamphorLeavesBlock(BlockBehaviour.Properties.copy(Blocks.OAK_LEAVES)));
    ...
    public static final RegistryObject<Block> GOLDEN_CRABAPPLE =
    ...
    public static final RegistryObject<Block> CRABAPPLE_PILE =
    ...
    public static final RegistryObject<Block> GOLDEN_CRABAPPLE_PILE =
    ...
    public static final RegistryObject<Block> CLOUD_APRICOT_PILE =
    ...
    public static final RegistryObject<Block> IMMORTAL_PEACH_PILE =
    ...
    public static final RegistryObject<Block> MEI_PILE =
    ...
    public static final RegistryObject<Block> GOLDEN_MEI_PILE =
    ...
    public static final RegistryObject<Block> GOLDEN_MEI_SAPLING =
            registerBlock("golden_mei_sapling", () -> new DesertSaplingBlock(new GoldenMeiTreeGrower(), BlockBehaviour.Properties.of().mapColor(MapColor.GOLD).noCollission().randomTicks().instabreak().sound(SoundType.CHERRY_SAPLING).pushReaction(PushReaction.DESTROY)));
    ...
    public static final RegistryObject<Block> POTTED_GOLDEN_MEI_SAPLING =
    ...
    public static final RegistryObject<Block> LOTUS =
            BLOCKS.register("lotus", () -> new WaterLotusBlock(BlockBehaviour.Properties.copy(Blocks.LILY_PAD).mapColor(MapColor.COLOR_PINK).noCollission().offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final RegistryObject<Block> GOLD_SAND =
            registerBlock("gold_sand", () -> new SandBlock(16766720, BlockBehaviour.Properties.copy(Blocks.SAND).mapColor(MapColor.GOLD)));
