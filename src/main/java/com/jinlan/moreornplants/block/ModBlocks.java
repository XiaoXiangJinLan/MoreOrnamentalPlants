...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> WHITE_CRABAPPLE_LEAVES =
            registerBlock("white_crabapple_leaves", () -> new WhiteCrabappleLeavesBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CHERRY_LEAVES).mapColor(MapColor.SNOW)));
    ...
    public static final DeferredBlock<Block> CLOUD_APRICOT_LEAVES =
            registerBlock("cloud_apricot_leaves", () -> new CloudApricotLeavesBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CHERRY_LEAVES)));
    ...
    public static final DeferredBlock<Block> RED_CRAPE_MYRTLE_LEAVES =
            registerBlock("red_crape_myrtle_leaves", () -> new RedCrapeMyrtleLeavesBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES).mapColor(MapColor.COLOR_PURPLE)));
    public static final DeferredBlock<Block> PINK_CRAPE_MYRTLE_LEAVES =
            registerBlock("pink_crape_myrtle_leaves", () -> new PinkCrapeMyrtleLeavesBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES).mapColor(MapColor.COLOR_PINK)));
    public static final DeferredBlock<Block> WHITE_CRAPE_MYRTLE_LEAVES =
            registerBlock("white_crape_myrtle_leaves", () -> new WhiteCrapeMyrtleLeavesBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES).mapColor(MapColor.SNOW)));
    ...
    public static final DeferredBlock<Block> BLUE_CHINESE_WISTERIA =
    ...
    public static final DeferredBlock<Block> BLUE_CHINESE_WISTERIA_PLANT =
    ...
    public static final DeferredBlock<Block> RED_CHINESE_WISTERIA =
    ...
    public static final DeferredBlock<Block> RED_CHINESE_WISTERIA_PLANT =
    ...
    public static final DeferredBlock<Block> NANJING_WISTERIA =
    ...
    public static final DeferredBlock<Block> NANJING_WISTERIA_PLANT =
    ...
    public static final DeferredBlock<Block> GREEN_CALYX_MEI_SIGN =
            BLOCKS.register("green_calyx_mei_sign", () -> new ModStandingSignBlock(ModWoodTypes.GREEN_CALYX_MEI, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN).mapColor(MapColor.COLOR_LIGHT_GREEN)));
    public static final DeferredBlock<Block> DOUBLE_PINK_MEI_SIGN =
            BLOCKS.register("double_pink_mei_sign", () -> new ModStandingSignBlock(ModWoodTypes.DOUBLE_PINK_MEI, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN).mapColor(MapColor.COLOR_PINK)));
    public static final DeferredBlock<Block> CRABAPPLE_SIGN =
            BLOCKS.register("crabapple_sign", () -> new ModStandingSignBlock(ModWoodTypes.CRABAPPLE, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN).mapColor(MapColor.COLOR_MAGENTA)));
    public static final DeferredBlock<Block> APRICOT_SIGN =
            BLOCKS.register("apricot_sign", () -> new ModStandingSignBlock(ModWoodTypes.APRICOT, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN).mapColor(MapColor.COLOR_PINK)));
    public static final DeferredBlock<Block> PEACH_SIGN =
            BLOCKS.register("peach_sign", () -> new ModStandingSignBlock(ModWoodTypes.PEACH, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN).mapColor(MapColor.COLOR_PINK)));
    public static final DeferredBlock<Block> PEAR_SIGN =
            BLOCKS.register("pear_sign", () -> new ModStandingSignBlock(ModWoodTypes.PEAR, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN).mapColor(MapColor.SAND)));
    public static final DeferredBlock<Block> PURPLE_LEAF_PLUM_SIGN =
            BLOCKS.register("purple_leaf_plum_sign", () -> new ModStandingSignBlock(ModWoodTypes.PURPLE_LEAF_PLUM, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN).mapColor(MapColor.TERRACOTTA_PURPLE)));
    ...
    public static final DeferredBlock<Block> GOLDEN_MEI_SAPLING =
            registerBlock("golden_mei_sapling", () -> new DesertSaplingBlock(ModTreeGrower.GOLDEN_MEI, BlockBehaviour.Properties.of().mapColor(MapColor.GOLD).noCollission().randomTicks().instabreak().sound(SoundType.CHERRY_SAPLING).pushReaction(PushReaction.DESTROY)));
    ...
    public static final DeferredBlock<Block> WHITE_CRABAPPLE_SAPLING =
            registerBlock("white_crabapple_sapling", () -> new SaplingBlock(ModTreeGrower.WHITE_CRABAPPLE, BlockBehaviour.Properties.of().mapColor(MapColor.SNOW).noCollission().randomTicks().instabreak().sound(SoundType.CHERRY_SAPLING).pushReaction(PushReaction.DESTROY)));
    public static final DeferredBlock<Block> GOLDEN_CRABAPPLE_SAPLING =
            registerBlock("golden_crabapple_sapling", () -> new DesertSaplingBlock(ModTreeGrower.GOLDEN_CRABAPPLE, BlockBehaviour.Properties.of().mapColor(MapColor.GOLD).noCollission().randomTicks().instabreak().sound(SoundType.CHERRY_SAPLING).pushReaction(PushReaction.DESTROY)));
    ...
    public static final DeferredBlock<Block> CLOUD_APRICOT_SAPLING =
            registerBlock("cloud_apricot_sapling", () -> new SaplingBlock(ModTreeGrower.CLOUD_APRICOT, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PINK).noCollission().randomTicks().instabreak().sound(SoundType.CHERRY_SAPLING).pushReaction(PushReaction.DESTROY)));
    ...
    public static final DeferredBlock<Block> RED_CRAPE_MYRTLE_SAPLING =
    ...
    public static final DeferredBlock<Block> PINK_CRAPE_MYRTLE_SAPLING =
    ...
    public static final DeferredBlock<Block> WHITE_CRAPE_MYRTLE_SAPLING =
    ...
    public static final DeferredBlock<Block> POTTED_WHITE_CRABAPPLE_SAPLING =
    ...
    public static final DeferredBlock<Block> POTTED_CLOUD_APRICOT_SAPLING =
    ...
    public static final DeferredBlock<Block> POTTED_RED_CRAPE_MYRTLE_SAPLING =
            BLOCKS.register("potted_red_crape_myrtle_sapling", () -> flowerPot(RED_CRAPE_MYRTLE_SAPLING.get()));
    public static final DeferredBlock<Block> POTTED_PINK_CRAPE_MYRTLE_SAPLING =
            BLOCKS.register("potted_pink_crape_myrtle_sapling", () -> flowerPot(PINK_CRAPE_MYRTLE_SAPLING.get()));
    public static final DeferredBlock<Block> POTTED_WHITE_CRAPE_MYRTLE_SAPLING =
    ...
    public static final DeferredBlock<Block> CHINESE_NARCISSUS =
    ...
    public static final DeferredBlock<Block> GOLDEN_CHINESE_NARCISSUS =
    ...
    public static final DeferredBlock<Block> WHITE_MOTH_ORCHID =
    ...
    public static final DeferredBlock<Block> PINK_MOTH_ORCHID =
    ...
    public static final DeferredBlock<Block> PURPLE_MOTH_ORCHID =
    ...
    public static final DeferredBlock<Block> GOLDEN_MOTH_ORCHID =
    ...
    public static final DeferredBlock<Block> BRANCHY_TAMARISK =
    ...
    public static final DeferredBlock<Block> GOLDEN_BRANCHY_TAMARISK =
    ...
    public static final DeferredBlock<Block> POTTED_CHINESE_NARCISSUS =
            BLOCKS.register("potted_chinese_narcissus", () -> flowerPot(CHINESE_NARCISSUS.get()));
    public static final DeferredBlock<Block> POTTED_GOLDEN_CHINESE_NARCISSUS =
            BLOCKS.register("potted_golden_chinese_narcissus", () -> flowerPot(GOLDEN_CHINESE_NARCISSUS.get()));
    public static final DeferredBlock<Block> POTTED_WHITE_MOTH_ORCHID =
            BLOCKS.register("potted_white_moth_orchid", () -> flowerPot(WHITE_MOTH_ORCHID.get()));
    public static final DeferredBlock<Block> POTTED_PINK_MOTH_ORCHID =
            BLOCKS.register("potted_pink_moth_orchid", () -> flowerPot(PINK_MOTH_ORCHID.get()));
    public static final DeferredBlock<Block> POTTED_PURPLE_MOTH_ORCHID =
            BLOCKS.register("potted_purple_moth_orchid", () -> flowerPot(PURPLE_MOTH_ORCHID.get()));
    public static final DeferredBlock<Block> POTTED_GOLDEN_MOTH_ORCHID =
            BLOCKS.register("potted_golden_moth_orchid", () -> flowerPot(GOLDEN_MOTH_ORCHID.get()));
    public static final DeferredBlock<Block> POTTED_BRANCHY_TAMARISK =
            BLOCKS.register("potted_branchy_tamarisk", () -> flowerPot(BRANCHY_TAMARISK.get()));
    public static final DeferredBlock<Block> POTTED_GOLDEN_BRANCHY_TAMARISK =
    ...
    public static final DeferredBlock<Block> YAO_HUANG_PEONY =
    ...
    public static final DeferredBlock<Block> WEI_ZI_PEONY =
    ...
    public static final DeferredBlock<Block> DOU_GREEN_PEONY =
    ...
    public static final DeferredBlock<Block> LUOYANG_RED_PEONY =
    ...
    public static final DeferredBlock<Block> TALL_CAMELLIA =
    ...
    public static final DeferredBlock<Block> TALL_WHITE_CAMELLIA =
    ...
    public static final DeferredBlock<Block> TALL_PINK_CAMELLIA =
    ...
    public static final DeferredBlock<Block> TALL_VERSICOLOR_CAMELLIA =
    ...
    public static final DeferredBlock<Block> RED_CRAPE_MYRTLE =
    ...
    public static final DeferredBlock<Block> PINK_CRAPE_MYRTLE =
    ...
    public static final DeferredBlock<Block> WHITE_CRAPE_MYRTLE =
    ...
    public static final DeferredBlock<Block> HOLLYHOCK =
    ...
    public static final DeferredBlock<Block> PINK_HOLLYHOCK =
    ...
    public static final DeferredBlock<Block> ORANGE_HOLLYHOCK =
    ...
    public static final DeferredBlock<Block> WHITE_HOLLYHOCK =
    ...
    public static final DeferredBlock<Block> HARDY_BANANA =
    ...
    public static final DeferredBlock<Block> POTTED_CUT_COTTON_ROSE =
    ...
    public static final DeferredBlock<Block> WOOD_SORREL =
    ...
    public static final DeferredBlock<Block> PINK_WOOD_SORREL =
    ...
    public static final DeferredBlock<Block> WHITE_WOOD_SORREL =
    ...
    public static final DeferredBlock<Block> ORANGE_WOOD_SORREL =
    ...
    public static final DeferredBlock<Block> BLACK_LOTUS =
            BLOCKS.register("black_lotus", () -> new WaterLotusBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LILY_PAD).mapColor(MapColor.COLOR_BLACK).noCollission().offsetType(BlockBehaviour.OffsetType.XZ)));
    public static final DeferredBlock<Block> GREEN_LOTUS =
            BLOCKS.register("green_lotus", () -> new WaterLotusBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LILY_PAD).mapColor(MapColor.PLANT).noCollission().offsetType(BlockBehaviour.OffsetType.XZ)));
    ...
    public static final DeferredBlock<Block> TALL_MUXUE_GRASS =
            registerBlock("tall_muxue_grass", () -> new TallMuxueGrassBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.TALL_SEAGRASS).lightLevel(p_220867_ -> 12)));
    ...
    public static final DeferredBlock<Block> GOLD_SAND =
            registerBlock("gold_sand", () -> new ColoredFallingBlock(new ColorRGBA(16766720), BlockBehaviour.Properties.ofFullCopy(Blocks.SAND).mapColor(MapColor.GOLD)));

    public static final DeferredBlock<Block> BAMBOO_SHOOTS_SOUP =
    ...
    public static final DeferredBlock<Block> LOTUS_ROOT_SOUP =
