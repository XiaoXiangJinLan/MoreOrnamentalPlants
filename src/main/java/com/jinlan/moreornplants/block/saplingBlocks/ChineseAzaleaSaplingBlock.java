...
import com.jinlan.moreornplants.worldgen.tree.ChineseAzaleaTreeGrower;
...
public class ChineseAzaleaSaplingBlock extends ModFlowerBlock implements BonemealableBlock {
    private static final ChineseAzaleaTreeGrower TREE_GROWER = new ChineseAzaleaTreeGrower();
