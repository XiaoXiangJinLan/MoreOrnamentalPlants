...
public class LaMeiXiangnangBlockEntity extends BlockEntity {
    ...
    public LaMeiXiangnangBlockEntity(BlockPos pos, BlockState blockState) {
        super(ModBlockEntities.LA_MEI_XIANGNANG.get(), pos, blockState);
    }

    public static void tick(Level level, BlockPos pos, BlockState state, LaMeiXiangnangBlockEntity blockEntity) {
        // 确保只在服务端运行
