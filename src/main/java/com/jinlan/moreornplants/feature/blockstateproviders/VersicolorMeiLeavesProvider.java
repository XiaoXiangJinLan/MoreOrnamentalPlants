...
public class VersicolorMeiLeavesProvider extends BlockStateProvider {
    public static final MapCodec<VersicolorMeiLeavesProvider> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(
    ...
    @Override
    @NotNull
    public BlockState getState(RandomSource random, @NotNull BlockPos pos) {
