...
public class FallenLogDecorator extends TreeDecorator {
    public static final MapCodec<FallenLogDecorator> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(
    ...
    public void place(TreeDecorator.Context context) {
        ...
        int baseGroundY = logs.stream().mapToInt(BlockPos::getY).min().orElse(logs.getFirst().getY());
