...
public class PeachTrunkPlacer extends TrunkPlacer {
    public static final Codec<PeachTrunkPlacer> CODEC = RecordCodecBuilder.create(
            ...
            ).apply(instance, PeachTrunkPlacer::new)
    );
    ...
    public PeachTrunkPlacer(int baseHeight, int heightRandA, int heightRandB,
